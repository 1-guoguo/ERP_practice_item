...
// const SubMenu = Menu.SubMenu
  ...
  const items = [
    getItem('销售管理', 'sub1', <MailOutlined />, [
      getItem('销售订单', null, null, [getItem('新增销售订单', '1'), getItem('销售订单管理', '2')], 'group'),
      getItem('销售单据', null, null, [getItem('新增销售出库单', '3'), getItem('新增销售退货单', '4'), getItem('新增销售换货单', '5'), getItem('销售单据查询', '6')], 'group'),
    ]),
    getItem('采购管理', 'sub2', <AppstoreOutlined />, [
    ...
    getItem('财务管理', 'sub5', <SettingOutlined />, [
